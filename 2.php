...
<title>فارسی ساز بخش کاربری whmcs پی سی وب</title>
<style>
@import 'http://p30web.org/wp-content/themes/p30webv3/fonts.css';
</style>
</head>
<body>
  <div style=\"border: 1px dashed #CC0000;font:15px IRANSans;background-color: #FBEEEB;padding: 10px;color: #CC0000;direction: rtl;line-height: 2;\">
    <strong>دسترسی رد شد</strong><br>
    شما امکان دسترسی به این فایل را ندارید.
<br/>
قدرت گرفته از : <a href='http://www.p30web.org/fwhmcs/' style='text-decoration:none;font-weight:500;' target='_blank'>دبلیو اچ ام سی اس فارسی</a>
<br/>
فارسی سازی توسط :  <a href='http://p30web.org' style='text-decoration:none;font-weight:500' target='_blank'>پی سی وب</a>
<br>
<strong>توجه : </strong> کاربر گرامی در صورتی که مایل هستید از آخرین نسخه فارسی ساز whmcs را داریافت کنید میتوانید به لیتک :
<a href='http://p30web.org/' style='text-decoration:none;font-weight:500' target='_blank'>دانلود فارسی ساز کامل whmcs</a>
</div>
...
$_LANG['clientareaphonenumber'] = "تلفن ثابت:";
...
$_LANG['pwdoesnotmatch'] = "کلمه عبور وارد شده مطابقت ندارد";
...
$_LANG['supportticketsuploadtoolarge'] = "فایل آپلود شده بیش از حد بزرگ بود. لطفا سعی کنید یک فایل کوچکتر را آپلود نمایید .";
...
$_LANG['configoptionqtyminmax'] = "%s دارای حداقل نیاز %s و حداکثر %s";
...
$_LANG['cartsetupfees'] = "هزینه  های جانبی دیگر";
...
$_LANG['captchaverify'] = "لطفا کارکترهایی که در عکس زیر مشاهده میکنید را وارد کنید .";
...
$_LANG['supportticketsticketlastupdated'] = "آخرین بروزرسانی";
...
$_LANG['feedbacksupplyrating'] = "لطفا امتیازی به این پاسخ دهید(اختیاری) می باشد ";
...
$_LANG['twoiptimebasedpassword'] = "زمان پایه برای رمز عبور یکبار مصرف";
...
$_LANG['clientHomePanels']['affiliateSummary'] = "متوسط کمیسیون فعلی شما برابر است با : :commissionBalance . شما فقط برای دریافت کمییسیون کافی هست حداقل: :amountUntilWithdrawalLevel دیگر کسب نمایید ، سپس میتوانید درخواست دریافت وجه خود را برای ما ارسال نمایید . ";
$_LANG['clientHomePanels']['affiliateSummaryWithdrawalReady'] = "متوسط کمیسیون بازارایابی شما هم اکنون : :commissionBalance می باشد ، ممکن است میزان کمییسون شما بیشتر نیز شده باشد . ";
...
$_LANG['affiliateWithdrawalSummary'] = "شما می توانید زمانی که میزان مبلغ بازاریابیتان به حد نصاب :amountForWithdrawal رسید درخواست دریافت وجه نمایید . ";
...
$_LANG['cPanel']['emailAccounts'] = "حساب ایمیل";
$_LANG['cPanel']['forwarders'] = "فوروارد (Forwarders)";
$_LANG['cPanel']['autoresponders'] = "پاسخگوی خودکار";
$_LANG['cPanel']['fileManager'] = "مدیریت فایل";
$_LANG['cPanel']['backup'] = "پشتیبان گیری";
$_LANG['cPanel']['subdomains'] = "زیر دامنه (Subdomains)";
$_LANG['cPanel']['addonDomains'] = "افزودن دامنه (Addon Domains)";
$_LANG['cPanel']['cronJobs'] = "برنامه زمانی (Cron Jobs)";
$_LANG['cPanel']['mysqlDatabases'] = "پایگاه داده (MySQL Databases)";
$_LANG['cPanel']['phpMyAdmin'] = "مدیریت پایگاه داده (phpMyAdmin)";
$_LANG['cPanel']['awstats'] = "Awstats";

$_LANG['cPanel']['createEmailAccount'] = "ایجاد سریع یک حساب کاربری ایمیل";
$_LANG['cPanel']['usernamePlaceholder'] = "نام کاربری";
$_LANG['cPanel']['passwordPlaceholder'] = "رمز عبور مورد نظر شما";
$_LANG['cPanel']['create'] = "ايجاد كردن";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "حساب ایمیل با موفقیت ایجاد!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "ایجاد حساب کاربر ایمیل ناموفق بود :  ";
...
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "ما به شما پیشنهاد میکنیم احراز هویت دو مرحله ای را جهت امنیت بیشتر حساب کاربری خودتون فعال نمایید . ";
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "تنظیم یک سئوال و پاسخ امنیتی میتواند باعث حفاظت از حساب کاربری شما شود ، و از دسترسی افراد غیر مجاز به حساب کاربری شما جلوگیری میکند ، این سئوال و پاسخ امنیتی به ما کمک میکند که هویت شما را شناسایی کنیم . و این گونه افراد غیر مجاز نمیتوانند به راحتی به حساب کاربری شما دسترسی داشته باشند . ";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "تنظیم یک سئوال و پاسخ امنیتی میتواند باعث حفاظت از حساب کاربری شما شود ، و از دسترسی افراد غیر مجاز به حساب کاربری شما جلوگیری میکند ، این سئوال و پاسخ امنیتی به ما کمک میکند که هویت شما را شناسایی کنیم . و این گونه افراد غیر مجاز نمیتوانند به راحتی به حساب کاربری شما دسترسی داشته باشند . ";
...
$_LANG['orderForm']['domainAlternativeContact'] = "شما ممکن است بخواهید  با نام ومشخصات فرد دیگری دامنه را ثبت نمایید ، مثلا از طرف یک شخص یا سازمان خاصی دامنه را ثبت کنید ، در این صورت نیاز دارید که اطلاعات تماس خودتون رو تغییر دبدید . از طریق این بخش میتوانید اطلاعات تماس خودتون رو تغییر دهید ، اگر نمیخواهید اطلاعات تماس خود را تغییر دهید ، میتوانید از تغییر این بخش صرف نظر کنید . ";
...
$_LANG['orderForm']['configureDesiredOptions'] = "برای تکمیل فرآیند ، گزینه های دلخواه خود را تنظیم نمایید و سپس برای ادامه سفارش بر روی گزینه ادامه کلیک کنید.";
...
$_LANG['orderForm']['extendExclusions'] = "پسوند های خاص دارای استثنا هایی می باشند . ";
