<?php
//Nulled By Alireza Ahmadi From p30web.org
// bug report : https://my.p30web.org/submitticket.php?step=2&deptid=2
// WebSite Url : p30web.org
namespace WHMCS;
    ...
    public function remoteCheck($forceRemote = false)
    {
        try {
            ...
            if (!$localkeyvalid || $forceRemote) {
                ...
                $results["productname"] = "WHMCS 7.4.2 - Nulled By p30web";
                $results["productid"] = "5";
